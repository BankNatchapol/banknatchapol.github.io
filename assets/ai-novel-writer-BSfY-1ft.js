import{j as e}from"./index-CRRJTpJk.js";function r(n){const t={a:"a",code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Overview"}),`
`,e.jsxs(t.p,{children:[e.jsx(t.strong,{children:"AI Novel Writer"})," is a one-shot generation tool that produces a complete, structured novel with character illustrations from a single JSON configuration file. Given a theme, language, characters, and writing style, it generates everything in sequence — title, two-paragraph summary, character profiles, table of contents, chapter introductions, and full section content — with a character state that updates after each chapter to track relationship changes and story arc progression."]}),`
...
`]}),`
`,e.jsx(t.hr,{}),`
`,e.jsx(t.h2,{children:"Context and memory engineering"}),`
...
`,e.jsx(t.h3,{children:"Chapter and section continuity"}),`
