import{j as e}from"./index-Ba36zmeE.js";import{u as t}from"./index-CJVBcA1t.js";function s(n){const r={a:"a",code:"code",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(r.h2,{children:"Overview"}),`
...
`]}),`
`,e.jsx(r.h2,{children:"Stack"}),`
`,e.jsxs(r.ul,{children:[`
`,e.jsxs(r.li,{children:[e.jsx(r.code,{children:"PyTorch"})," · ",e.jsx(r.code,{children:"PyTorch Geometric"})," · ",e.jsx(r.code,{children:"CUDA"})," · ",e.jsx(r.code,{children:"Python"})]}),`
`]}),`
`,e.jsx(r.h2,{children:"Links"}),`
`,e.jsxs(r.ul,{children:[`
`,e.jsx(r.li,{children:e.jsx(r.a,{href:"https://github.com/BankNatchapol/ml-decoder",children:"GitHub →"})}),`
`]})]})}function c(n={}){const{wrapper:r}={...t(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(s,{...n})}):s(n)}export{c as default};
