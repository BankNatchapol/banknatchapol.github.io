import{j as e}from"./index-CRRJTpJk.js";function a(s){const n={a:"a",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Overview"}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Thai G2P"})," is a Thai grapheme-to-phoneme system built on MarianMT. Standard Thai phonemizers fail in two ways — this fixes both, and the trained model handles words that rule-based and FST approaches can't touch."]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Result:"})," The trained model handles OOV words that were entirely outside the reach of existing Thai phonemizers — no rule-based fallback needed."]}),`
`,e.jsx(n.hr,{}),`
