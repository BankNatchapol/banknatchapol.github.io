import{j as n}from"./index-CRRJTpJk.js";function t(i){const e={a:"a",em:"em",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...i.components},{Diagram:r}=e;return r||s("Diagram"),n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"Overview"}),`
...
`,n.jsx(e.p,{children:"Prior DQI work was mainly theoretical, with only high-level circuit sketches. This repository gives an explicit, end-to-end circuit implementation of the DQI pipeline — state preparation, constraint encoding, coherent decoding, postselection, Hadamard transformation, measurement, simulation, and resource estimation."}),`
`,n.jsx(e.h2,{children:"Project goals"}),`
`,n.jsx(e.p,{children:"The goal is to make DQI executable and analyzable at the circuit level."}),`
...
`,n.jsx(r,{src:"/diagrams/dqi-circuit-pipeline.excalidraw",maxHeight:"900px",caption:"End-to-end DQI circuit pipeline"}),`
...
`]}),`
`,n.jsx(e.p,{children:"The repository implements the paper and serves as a reference for future DQI circuit experiments."}),`
...
`]})]})}function c(i={}){const{wrapper:e}=i.components||{};return e?n.jsx(e,{...i,children:n.jsx(t,{...i})}):t(i)}function s(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default};
