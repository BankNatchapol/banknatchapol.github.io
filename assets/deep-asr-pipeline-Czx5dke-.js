import{j as n}from"./index-DZSQNVgt.js";function a(i){const e={a:"a",code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...i.components},{Diagram:s}=e;return s||t("Diagram"),n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"Overview"}),`
...
`,n.jsxs(e.p,{children:[`| File | Contents |
|------|----------|
| `,n.jsx(e.code,{children:"final_small_file_segment_n.wav"}),` | Clean, aligned speech clip |
| `,n.jsx(e.code,{children:"metadata.csv"})," | ",n.jsx(e.code,{children:"filepath, transcript"})," pairs ready for training |"]}),`
`,n.jsx(e.hr,{}),`
...
`]})]})}function l(i={}){const{wrapper:e}=i.components||{};return e?n.jsx(e,{...i,children:n.jsx(a,{...i})}):a(i)}function t(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as default};
