import{j as e}from"./index-D99Tb35U.js";function r(i){const n={h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Overview"}),`
...
`,e.jsx(n.p,{children:`| | Boundary Precision |
|---|---|
| MFA baseline (Phonetisaurus) | ~100ms |
| This pipeline | sub-millisecond |`}),`
`,e.jsxs(n.p,{children:["A ",e.jsx(n.strong,{children:"~100× improvement"})," in temporal precision — alignment boundaries are now accurate to under a millisecond, enabling reliable phoneme-level supervision for downstream TTS and ASR training."]}),`
`,e.jsx(n.hr,{}),`
