import{j as e}from"./index-DLyql0A1.js";function r(t){const i={a:"a",code:"code",em:"em",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.h2,{children:"Overview"}),`
...
`,e.jsxs(i.p,{children:[e.jsx(i.strong,{children:"Unambiguous State Discrimination (USD)"})," — Quantum state discrimination approach; useful as a baseline for comparing interferometric advantage."]}),`
