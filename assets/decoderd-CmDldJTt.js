import{j as e}from"./index-CXAlhEJo.js";function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Overview"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Rust"})," · ",e.jsx(n.code,{children:"POSIX shared memory"})," · ",e.jsx(n.code,{children:"lock-free IPC"})," · ",e.jsx(n.code,{children:"QEC"})]}),`
`]}),`
`,e.jsx(n.h2,{children:"Links"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://github.com/BankNatchapol/decoderd",children:"GitHub →"})}),`
`]})]})}function i(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{i as default};
