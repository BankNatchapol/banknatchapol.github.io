import{j as e}from"./index-Ci3by5lC.js";function r(i){const n={a:"a",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs("figure",{style:{margin:"0 0 48px",borderRadius:"8px",overflow:"hidden",border:"1px solid var(--paper-edge)"},children:[e.jsx("img",{src:"/images/praat.png",alt:"Praat TextGrid output showing Thai phoneme alignment",style:{width:"100%",display:"block"}}),e.jsx("figcaption",{style:{fontFamily:"var(--font-mono)",fontSize:"13px",color:"var(--ink-500)",textAlign:"center",padding:"10px 12px",fontStyle:"italic",letterSpacing:"0.03em"},children:"Praat — waveform, spectrogram, and aligned Thai phoneme boundaries in TextGrid"})]}),`
...
`]})]})}function t(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{t as default};
