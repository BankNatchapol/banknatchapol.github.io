import{j as n}from"./index-DSTxoQw8.js";function s(i){const e={a:"a",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...i.components},{Diagram:t}=e;return t||a("Diagram"),n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"Overview"}),`
`,n.jsxs(e.p,{children:[n.jsx(e.strong,{children:"ID Checker"})," is an AI-powered name verification system built for a government business registration authority. It automatically validates whether a Thai/English name pair is linguistically consistent, compliant with naming rules, and not a duplicate of existing records — replacing slow, inconsistent manual officer review."]}),`
...
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"https://github.com/BankNatchapol/check-id",children:"Live Demo →"})}),`
